...
```
go install github.com/kt-micro/protoc-gen-micro
```
...
```
protoc --proto_path=$GOPATH/src:. --go_out=paths=source_relative:. --micro_out=paths=source_relative:. greeter.proto
```
...
./
    ...
    greeter.micro.go	# auto-generated by protoc-gen-microgs
```
